...
import 'package:untitled/presentaion/auth/screens/verify_found_account.dart';
import '../../../core/constant/colors.dart';
import '../../../network_exceptions.dart';
import '../../../components.dart';

import '../manager/forget_password/forget_password_cubit.dart';
import '../manager/forget_password/forget_password_state.dart';
                    ...
                    return GestureDetector(
                      onTap: () {
                        if (formKey.currentState!.validate()) {
                          var result =
                          context.read<ForgetPasswordCubit>().emitForgetPassword(email:  emailForForgetPassword.text);
                          return result;
                        }
                        return null;
                      },
