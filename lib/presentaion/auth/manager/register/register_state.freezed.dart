...
class __$$IdelImplCopyWithImpl<T, $Res>
    extends _$RegisterStateCopyWithImpl<T, $Res, _$IdelImpl<T>>
...
abstract class Idel<T> implements RegisterState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.error(networkExceptions: $networkExceptions)';
  }
