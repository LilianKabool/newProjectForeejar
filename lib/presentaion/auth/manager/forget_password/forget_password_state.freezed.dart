...
class __$$IdelImplCopyWithImpl<T, $Res>
    extends _$ForgetPasswordStateCopyWithImpl<T, $Res, _$IdelImpl<T>>
...
class _$IdelImpl<T> implements Idel<T> {
  ...
  @override
  String toString() {
    return 'ForgetPasswordState<$T>.idel()';
  }
...
abstract class Idel<T> implements ForgetPasswordState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'ForgetPasswordState<$T>.error(networkExceptions: $networkExceptions)';
  }
