...
class __$$IdelImplCopyWithImpl<T, $Res>
    extends _$ResetPasswordStateCopyWithImpl<T, $Res, _$IdelImpl<T>>
...
class _$IdelImpl<T> implements Idel<T> {
  ...
  @override
  String toString() {
    return 'ResetPasswordState<$T>.idel()';
  }
...
abstract class Idel<T> implements ResetPasswordState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'ResetPasswordState<$T>.error(networkExceptions: $networkExceptions)';
  }
